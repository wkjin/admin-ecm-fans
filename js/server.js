var server = {
    _options: {
        ...
        //pdf文件
        pdfUploadServer: 'File/pdfUpload',
        getPDFFilsUrl: 'File/getPDFFils',
    },
    ...
    getPdfUploadUrl: function () {
        var self = this;
        return self._options.host + self._options.pdfUploadServer;
    },
    pdfUpload: function (data, callback) {
        var self = this;
        $.ajax({
            type: 'POST',
            url: self.getPdfUploadUrl(),
            data: data,
            cache: false,
            processData: false,
            contentType: false,
    ...
    //获取pdf文件列表
    getPDFFils: function (callback) {
        this.requestAndCallBack({}, this._options.getPDFFilsUrl, callback);
    },
